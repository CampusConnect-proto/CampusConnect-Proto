...
export default function Home() {
  const heroImage = PlaceHolderImages.find(p => p.id === 'onboarding-student');
  ...
  const FeatureCard = ({ feature }: { feature: (typeof features)[0] }) => (
    <div className="group/feature flex h-full flex-col items-center text-center p-6 bg-card rounded-lg border shadow-sm transition-all duration-300 hover:shadow-xl">
      <div className="mb-5 inline-flex items-center justify-center rounded-full bg-primary/10 p-4 transition-transform duration-300 group-hover/feature:scale-110">
        {feature.icon}
      </div>
          ...
          <div className="relative z-10 container mx-auto px-4 md:px-6 h-full flex flex-col justify-center items-center text-center">
            <div className="animate-fade-in-up">
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <span className="text-3xl font-bold font-headline bg-gradient-to-r from-primary to-white bg-clip-text text-transparent">Campus Connect</span>
              </div>
              ...
              <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                  <Button size="lg" asChild className="font-bold text-lg transition-all duration-300 w-full sm:w-auto hover:-translate-y-0.5 rounded-full bg-white/30 text-white hover:bg-white/40 backdrop-blur-md border border-white/50 shadow-lg">
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center animate-fade-in-up">
             ...
             <div className="relative mt-12 w-full overflow-hidden group">
                <div className="flex group-hover:pause">
                    <div className="flex flex-shrink-0 animate-marquee items-center justify-around">
                     ...
                     <div className="flex flex-shrink-0 animate-marquee items-center justify-around" aria-hidden="true">
                        {features.map((feature, index) => (
                            <div key={`dup-${index}`} className="flex-shrink-0 w-[350px] mx-4">
                                <FeatureCard feature={feature} />
                            </div>
                        ))}
                    </div>
                </div>
                 <div className="absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-muted/40 to-transparent z-10 pointer-events-none"></div>
                <div className="absolute inset-y-0 right-0 w-24 bg-gradient-to-l from-muted/40 to-transparent z-10 pointer-events-none"></div>
            </div>
        </section>
            ...
            <div className="relative mt-16 max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 relative">
                ...
                <div className="text-center flex flex-col items-center group">
                  <div className="mb-6 flex items-center justify-center rounded-full bg-background border-2 border-primary/50 shadow-lg h-16 w-16 text-primary z-10 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12">
